...
public class BallRotateLoadingView extends BaseLoadingView {
    //默认值
    private final float RADIUS = dp2px(20);
    ...
    public BallRotateLoadingView(Context context) {
        this(context, null);
    }

    public BallRotateLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BallRotateLoadingView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);       TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.BaseLoadingView);
        radius1 = ta.getDimension(R.styleable.BaseLoadingView_radius1, RADIUS);
        radius2 = ta.getDimension(R.styleable.BaseLoadingView_radius2, RADIUS);
        gap = ta.getDimension(R.styleable.BaseLoadingView_gap, GAP);
        rtlScale = ta.getFloat(R.styleable.BaseLoadingView_rtlScale, RTL_SCALE);
        ltrScale = ta.getFloat(R.styleable.BaseLoadingView_ltrScale, LTR_SCALR);
        color1 = ta.getColor(R.styleable.BaseLoadingView_color1, LEFT_COLOR);
        color2 = ta.getColor(R.styleable.BaseLoadingView_color2, RIGHT_COLOR);
        mixColor = ta.getColor(R.styleable.BaseLoadingView_mixColor, MIX_COLOR);
        duration = ta.getInt(R.styleable.BaseLoadingView_duration, DURATION);
        pauseDuration = ta.getInt(R.styleable.BaseLoadingView_pauseDuration, PAUSE_DUARTION);
        scaleStartFraction = ta.getFloat(R.styleable.BaseLoadingView_scaleStartFraction, SCALE_START_FRACTION);
        scaleEndFraction = ta.getFloat(R.styleable.BaseLoadingView_scaleEndFraction, SCALE_END_FRACTION);
        ta.recycle();
    ...
    private void initAnim() {
        ...
        anim = ValueAnimator.ofFloat(0.0f, 1.0f, 0.0f);
